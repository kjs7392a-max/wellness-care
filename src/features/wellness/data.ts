...
export const OB: ObStep[] = [
  ...
  { kicker: "PAR-Q+ · 신체활동 준비 질문지", title: "시작하기 전에 몸 상태를 잠깐 여쭤볼게요", body: "PAR-Q+(Physical Activity Readiness Questionnaire)는 캐나다운동생리학회가 만든 국제 표준 문항이에요. 일곱 가지 답에 따라 제안하는 강도만 달라지고, 몸에 무리가 가는 동작은 권하지 않습니다.", btn: "시작하기" },
];
