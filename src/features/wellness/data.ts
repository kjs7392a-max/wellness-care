...
export const OB: ObStep[] = [
  ...
  { kicker: "먼저 약속드립니다", title: "이 앱은 선생님을 평가하지 않습니다", body: "점수나 순위를 매기지 않아요. 시작하기 전에 다섯 가지를 먼저 약속드립니다.", btn: "다음" },
  ...
  { kicker: "동의·권한", title: "수집동의서 및 권한허용", body: "모으는 것은 아래 세 가지가 전부이고, 모두 선생님께 제안을 드리는 데만 쓰입니다. 권한을 허용하지 않아도 나머지는 그대로 동작하지만 허용하시면 더 정확한 결과를 얻을 수 있습니다.", btn: "동의하고 계속" },
  ...
  { kicker: "안전 확인", title: "PAR-Q+를 통해 몸 상태를 잠깐 여쭤볼게요", body: "캐나다운동생리학회가 만든 국제 표준 신체활동 준비 질문지예요. 일곱 가지 답에 따라 제안하는 강도만 달라지고, 몸에 무리가 가는 동작은 권하지 않습니다.", btn: "시작하기" },
];
