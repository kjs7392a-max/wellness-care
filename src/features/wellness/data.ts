...
export const OB: ObStep[] = [
  ...
  { kicker: "동의·권한", title: "수집·이용 동의서", body: "권한을 허용하지 않아도 나머지는 그대로 동작하지만 허용하시면 더 정확한 결과를 얻을 수 있습니다.", btn: "동의하고 계속" },
  { kicker: "직군", title: "어떤 일을 하고 계신가요?", body: "쌓이는 피로의 자리가 서로 달라서, 제안하는 내용도 달라집니다. 나중에 바꿀 수 있어요.", btn: "다음" },
  { kicker: "안전 확인 (PAR-Q+)", title: "몸을 움직이기 전에 확인할 게 있어요", body: "운동을 시작하기 전 세계적으로 쓰이는 표준 확인 문항(PAR-Q+, 신체활동 준비 질문지) 7개예요. 몸에 무리가 가는 동작을 권하지 않기 위한 절차이고, 답에 따라 강도만 달라집니다.", btn: "시작하기" },
];
