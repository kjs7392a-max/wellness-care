...
export const PRINCIPLES = [
  "수집한 기록은 이 기기를 벗어나지 않습니다",
  "학교와 교육청은 개인의 기록을 볼 수 없습니다",
...
export const COLLECT = [
  { name: "걸음과 활동", why: "평소의 움직임과 얼마나 달라졌는지만 봅니다. 목표치나 만 보 기준은 쓰지 않아요." },
  { name: "함께한 몸풀기", why: "앱에서 직접 해보신 스트레칭의 횟수와 시간만 셉니다." },
  { name: "움직인 시간", why: "걷기와 계단처럼 몸을 움직인 시간만 셉니다. 어디에서 무엇을 하셨는지는 알 수 없어요." },
  { name: "직접 남기신 기록", why: "「오늘의 그림」 선택. 고르지 않으셔도 됩니다." },
];
...
export const OB: ObStep[] = [
  ...
  { kicker: "무엇을 모으나요", title: "모으는 것은 이만큼이 전부예요", body: "모두 이 기기 안에서만 쓰입니다.", btn: "다음" },
  { kicker: "동의", title: "두 가지 동의를 따로 받습니다", body: "묶어서 받지 않아요. 두 번째 항목에 동의하지 않으셔도 앱은 그대로 쓰실 수 있습니다.", btn: "동의하고 계속" },
  ...
  { kicker: "권한", title: "이제 거의 다 왔어요", body: "허용하지 않으셔도 됩니다. 그만큼만 덜 보고, 나머지는 그대로 동작해요.", btn: "시작하기" },
];
